...
export const LocationDropdownOnly = ({
  ...
  return (
    <Popover open={isDropdownSearchOpen} onOpenChange={setIsDropdownSearchOpen}>
      {/* --- THIS IS THE FIX --- */}
      {/* The PopoverTrigger now wraps the container div. */}
      <PopoverTrigger asChild className={cn("mx-auto mt-4 w-full", className)}>
      ...
      <PopoverContent
        className="no-scrollbar max-h-[420px] overflow-y-auto rounded-[6px] border border-blue-300 p-0 shadow-md"
        align="start"
        sideOffset={4}
