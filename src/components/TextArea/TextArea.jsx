    ...
    >
      ...
      >
        <textarea
          ...
          name={name}
          placeholder={placeholder}
          className={`grow ${style.input} ${classInput} leading-[15.4px] lg:leading-[14.4px] text-sm font-semibold text-neutral-900 placeholder:text-neutral-600 lg:text-xs lg:font-medium`}
          disabled={disabled}
