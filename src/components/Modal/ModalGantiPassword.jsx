...
const ModalGantiPassword = ({ open, onOpenChange, onSubmit }) => {
  ...
  return (
    <Modal open={open} onOpenChange={onOpenChange}>
      <ModalContent size="small" className="h-[414px] w-[695px]">
        <ModalHeader />
        <div className="flex flex-col items-center gap-6 px-8 py-6">
          ...
          <FormContainer className="w-full md:!gap-4">
            ...
            <div className="col-span-full flex justify-end pr-6 text-xs font-medium text-primary-700">
            ...
            <div className="flex items-center">
              <Input
                ...
                icon={{
                  ...
                  right: (
                    ...
                    >
                      <IconComponent
                        src={showNew ? "/icons/eye.svg" : "/icons/eye-off.svg"}
                        height={24}
                        width={24}
                      />
                    </button>
              ...
              <div className="ml-1 h-auto w-auto">
                <InfoTooltip
