      ...
      >
        ...
        >
          ...
          <input
            ...
            name={name}
            placeholder={placeholder}
            className={`w-full min-w-[0px] ${style.input} ${classInput} leading-[14.4px] max-[600px]:leading-[15.4px] text-xs font-medium text-neutral-900 placeholder:text-neutral-600 max-[600px]:text-sm max-[600px]:font-semibold`}
            disabled={disabled}
          />
          {!isEmpty(icon.right) ? (
