      ...
      <div className="flex min-h-full items-center justify-center p-4 text-center max-[600px]:items-center">
        ...
        >
          <div className="mb-6 flex flex-col items-center gap-[18px] bg-white">
            <span className="text-1b1b leading-[19.2px] text-base font-bold">
              {title}
            </span>
          ...
          <div className="flex w-full items-center justify-between">
            ...
            >
              <span className="leading-[16.8px] text-sm font-semibold text-[#176CF7]">
                Batal
              </span>
            </button>
            <button
              ...
              autoFocus
            >
              <span className="leading-[16.8px] text-sm font-semibold text-neutral-50">
                Simpan
              </span>
            </button>
          </div>
