        ...
        >
          <div className="flex min-h-[28px] flex-1 flex-row flex-wrap content-start items-center gap-2">
            ...
            <input
              ...
              maxLength={maxLength}
              className={cn(
                "leading-[14.4px] h-8 min-w-[120px] flex-1 border-none bg-transparent text-xs font-medium text-neutral-900 placeholder-neutral-600 outline-none disabled:cursor-not-allowed",
