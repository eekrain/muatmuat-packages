...
export const getHasDriverScannedOnUnload = async (cacheKey) => {
...
export const useGetHasDriverScannedOnUnload = (orderId) =>
  useSWRMutateHook("getHasDriverScannedOnUnload", getOrderAlerts);
