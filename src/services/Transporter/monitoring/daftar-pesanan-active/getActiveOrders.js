  ...
  Data: {
    orders: [
      ...
      // LOADING status with multiple units (>1)
      {
        ...
        truckType: { id: "uuid", name: "Tronton" },
        carrierTruck: { id: "uuid", name: "Box" },
        truckCount: 4, // Multiple units - should show "Batalkan Armada" + "Batalkan Pesanan"
        totalWeight: 28,
        weightUnit: "ton",
        assignedVehicles: [
          {
      ...
      // UNLOADING status without SOS
      {
        id: "uuid22",
        orderCode: "MT25UNLOAD22",
        orderType: "SCHEDULED",
        ...
        assignedVehicles: [
          {
            ...
            hasSos: false,
            location: {
              currentLocation: "Kuta, Kab. Badung",
              distanceFromDropoff: "Sedang di lokasi bongkar",
            },
          },
          {
            id: "vehicle2",
      ...
      // UNLOADING status with SOS
      {
        id: "uuid23",
        orderCode: "MT25UNLOAD23",
        orderType: "INSTANT",
        ...
        pickupLocations: [
          ...
          },
          {
            id: "uuid2",
            sequence: 2,
            fullAddress: "Wiyung, Kota Surabaya",
            city: "Kota Surabaya",
            province: "Jawa Timur",
          },
        ],
        dropoffLocations: [
          ...
          },
          {
            id: "uuid2",
            sequence: 2,
            fullAddress: "Gianyar, Kab. Gianyar",
            city: "Kab. Gianyar",
            province: "Bali",
          },
        ],
        ...
        assignedVehicles: [
          {
            ...
            location: {
              currentLocation: "Mengwi, Kab. Badung",
              distanceFromDropoff: "15 km dari lokasi bongkar",
            },
          },
          {
            id: "vehicle2",
            ...
            hasSos: false,
            location: {
              currentLocation: "Denpasar, Kota Denpasar",
              distanceFromDropoff: "Sedang di lokasi bongkar",
            },
          },
          {
            ...
            location: {
              currentLocation: "Tabanan, Kab. Tabanan",
              distanceFromDropoff: "25 km dari lokasi bongkar",
            },
          },
        ],
        sosStatus: {
      ...
      // UNLOADING status with 1 unit (single unit scenario)
      {
        id: "uuid24",
        orderCode: "MT25UNLOAD24",
        orderType: "SCHEDULED",
        ...
        truckType: { id: "uuid", name: "Colt Diesel Engkel" },
        carrierTruck: { id: "uuid", name: "Box" },
        truckCount: 1, // Single unit - should show only "Batalkan Pesanan"
        totalWeight: 3.5,
        weightUnit: "ton",
        assignedVehicles: [
          {
            ...
            hasSos: false,
            location: {
              currentLocation: "Yogyakarta, Kota Yogyakarta",
              distanceFromDropoff: "Sedang di lokasi bongkar",
            },
          },
        ],
      ...
      // WAITING_CONFIRMATION_SHIPPER status
      {
        ...
        pickupLocations: [
          ...
          },
          {
            id: "uuid2",
            sequence: 2,
            fullAddress: "Gununganyar, Kota Surabaya",
            city: "Kota Surabaya",
            province: "Jawa Timur",
          },
        ],
        dropoffLocations: [
          ...
          },
          {
            id: "uuid2",
            sequence: 2,
            fullAddress: "Karanganyar, Kab. Karanganyar",
        ...
        assignedVehicles: [
          {
            ...
            location: {
              currentLocation: "Dukuh Kupang, Kota Surabaya",
              distanceFromPickup: "5 km dari lokasi muat",
            },
          },
          {
            id: "vehicle2",
            ...
            driverStatus: "WAITING_CONFIRMATION",
            location: {
              currentLocation: "Gununganyar, Kota Surabaya",
              distanceFromPickup: "3 km dari lokasi muat",
            },
          },
        ],
        sosStatus: { hasSos: false, sosCount: 0, sosUnits: [] },
