...
const mockApiResult = {
  ...
  Data: {
    ...
    // orderStatus: ORDER_STATUS.LOADING,
    // orderStatus: ORDER_STATUS.WAITING_CHANGE_FLEET,
    // orderStatus: ORDER_STATUS.FLEET_FOUND,
    orderStatusUnit: 1,
    truckCount: 3,
    orderType: "SCHEDULED",
    loadTimeStart: "2025-07-20T15:46:00.000Z",
    // loadTimeEnd: null,
    loadTimeEnd: "2025-07-20T19:46:00.000Z",
    ...
    locations: [
      ...
      // },
      {
        ...
        detailAddress:
          "Dear all, perhatian buat semuanya untuk laporan lembur maksimal dilaporkan h+1",
        coordinates: {
          latitude: -7.2741549,
          longitude: 112.7820621,
        },
      ...
      },
      {
        ...
        detailAddress: "sesuai aturan yang sudah ditetapkan.",
        coordinates: {
      ...
      // },
      {
        ...
        detailAddress:
          "Jadi kalau ada keterlambatan berhari2 bahkan sampe ganti minggu",
        coordinates: {
          latitude: -7.2925952,
          longitude: 112.7200837,
        },
      ...
      },
      {
        ...
        detailAddress: "berarti menjadi konsekuensi sendiri. Terima kasih.",
        coordinates: {
          latitude: -7.2925952,
          longitude: 112.7200837,
        },
