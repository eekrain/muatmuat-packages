...
import {
  filtersReducer,
  initialFiltersState,
} from "@/app/transporter/(main)/monitoring/reducers/filtersReducer";
import {
  MAP_ACTIONS,
  initialMapState,
  mapReducer,
} from "@/app/transporter/(main)/monitoring/reducers/mapReducer";
import {
  PANEL_ACTIONS,
  initialPanelsState,
  panelsReducer,
} from "@/app/transporter/(main)/monitoring/reducers/panelsReducer";
import {
  SELECTION_ACTIONS,
