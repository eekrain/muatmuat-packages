...
import TransporterChildCard from "./TransporterChildCard";

const ShipperParentCard = ({ group, userRole }) => {
      ...
      <Collapsible className="relative flex flex-col overflow-hidden border-b border-neutral-400 first:border-t first:border-t-neutral-400 last:!rounded-b-xl">
        ...
        <CollapsibleContent>
          <div className="space-y-3 px-4 py-3">
            {group.transporters.map((transporterGroup) => (
              <TransporterChildCard
                key={transporterGroup.transporter.id}
...
export default ShipperParentCard;
