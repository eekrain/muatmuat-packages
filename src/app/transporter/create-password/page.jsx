        ...
        <div className="flex w-full max-w-[440px] flex-col items-center gap-8">
          ...
          <div className="flex flex-col items-center gap-6 text-center">
            ...
            <p className="max-w-[411px] text-base font-medium leading-[19px] text-white">
              Email kamu berhasil didaftarkan, mohon buat password untuk akun
              kamu dibawah
            </p>
          </div>
            ...
            <div className="flex w-full flex-col gap-[18px]">
              ...
              <div className="relative w-full">
                <Input
                  ...
                  appearance={{
                    containerClassName:
                      "h-12 bg-white border-white hover:border-white focus-within:border-white",
                    inputClassName:
                      "text-neutral-900 placeholder-neutral-500 pr-12",
                  }}
                  icon={{
                    left: (
                      <IconComponent
