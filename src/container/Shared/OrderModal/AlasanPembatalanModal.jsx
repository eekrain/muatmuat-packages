...
import InputAlasanLainnya from "../../Transporter/Monitoring/DaftarPesananAktif/components/InputAlasanLainnya";
...
const FormSchema = v.pipe(
  v.object({
    selectedReason: v.pipe(
      v.string(),
      v.minLength(1, "Alasan pembatalan wajib diisi")
    ),
  ...
  return (
    <Modal open={isOpen} onOpenChange={handleOpenChange}>
      ...
      >
        ...
        <ModalTitle className="sr-only">Alasan Pembatalan</ModalTitle>
            ...
            <div className="flex flex-col gap-4 pr-[14px]">
              ...
              <div className="flex flex-col">
                <h3 className="mb-3.5 font-bold text-black">
                  Pilih Alasan Pembatalan<span className="">*</span>
                </h3>
