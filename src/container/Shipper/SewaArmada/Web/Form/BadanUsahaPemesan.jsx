            ...
            <div className="ml-6 flex gap-x-2 rounded-md border border-primary-700 bg-primary-50 p-3">
              ...
              <div className="flex flex-1 flex-col py-1">
                <div className="flex w-full flex-col gap-y-3">
                  <h4 className="leading-[14.4px] text-xs font-bold text-neutral-900">
                    {name}
                  </h4>
                  <div className="flex items-center gap-x-2">
                    <IconComponent src="/icons/nomor-amandemen16.svg" />
                    <div>
                      <div className="leading-[14.4px] text-xs font-medium text-neutral-900">
                        {"Nomor NPWP :"}
                      </div>
                      <div className="leading-[14.4px] text-xs font-semibold text-neutral-900">
                        {taxId}
                      </div>
                    </div>
                  </div>
          ...
          <div className="flex flex-col gap-y-4 px-6 py-8">
            ...
            <div className="flex w-full flex-col items-start gap-3">
              ...
              <div className="flex w-full flex-col gap-3">
                <label className="leading-[14.4px] text-xs font-medium text-neutral-600">
