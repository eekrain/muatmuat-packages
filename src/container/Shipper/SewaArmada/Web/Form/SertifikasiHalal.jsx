...
const SertifikasiHalal = () => {
  ...
  return (
    <FormContainer className="flex gap-8">
      <div className="leading-[1.1] md:leading-[1.2] flex gap-2 text-sm font-semibold text-neutral-900 md:h-4 md:w-[174px] md:text-xs md:font-medium md:text-neutral-600">
        <div className="">
