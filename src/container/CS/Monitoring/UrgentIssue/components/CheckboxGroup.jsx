...
const CheckBoxGroup = ({
  ...
  return (
    <div
      className={cn(
        "relative flex items-center gap-[8px] text-xs text-neutral-600",
        className
      )}
    ...
    >
      ...
      <span
        className={cn(
          "capsize select-none text-sm font-semibold leading-[15.4px] text-neutral-600 md:text-xs md:font-medium md:leading-[14.4px]",
