  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-30">
      <div className="relative w-[600px] rounded-xl bg-white p-6 shadow-lg">
        ...
        />
        {/* List Transporter */}
        <div className="max-h-[337px] space-y-4 overflow-y-auto pr-2">
          <div className="relative rounded-xl border border-neutral-400 bg-neutral-100">
            ...
            <div className="flex items-center justify-between p-4">
              ...
              <div className="flex items-center gap-3">
                <div className="flex h-14 w-14 items-center justify-center rounded-full border border-neutral-300">
                  <img className="rounded-full border border-neutral-300 object-cover" />
                </div>
                <div>
            ...
            <div className="mx-4 border-b border-neutral-400"></div>
            <div className="p-4">
