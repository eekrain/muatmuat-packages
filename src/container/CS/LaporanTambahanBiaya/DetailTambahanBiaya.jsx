      ...
      <main className="mt-6">
        <Tabs defaultValue="ringkasan-pesanan">
          <TabsList className="flex w-4/12 justify-start text-primary-700">
            ...
            <TabsTrigger value="riwayat-hubungi">Riwayat Hubungi</TabsTrigger>
          </TabsList>
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <Modal>
                        ...
                        <ModalContent className="w-[578px] p-6">
                          ...
                          <p className="mt-4 text-center text-sm">
                            Detail biaya overload muatan akan ditampilkan di
                            sini.
                          </p>
                        </ModalContent>
                      </Modal>
          ...
          <TabsContent value="riwayat-hubungi">
            <div className="mt-6 text-center">
              <p className="text-neutral-500">
                Riwayat hubungi akan ditampilkan di sini.
              </p>
            </div>
          </TabsContent>
        </Tabs>
