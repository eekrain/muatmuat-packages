  ...
  drivers: [
    ...
    },
    {
      dataDriver: {
        ...
        name: "Ardian Eka Pratama",
        phoneNumber: "081234567893",
        profileImage: "https://picsum.photos/50?random=3",
        orderStatus: OrderStatusEnum.PREPARE_DOCUMENT,
        driverStatus: "DOKUMEN_SEDANG_DISIAPKAN",
        statusTitle: "Dokumen Sedang Disiapkan",
      ...
      statusDefinitions: [
        ...
        },
        {
          ...
          children: [
            {
              statusCode: `${DriverStatusEnum.UNLOADING.SELESAI.code}_2`,
              statusName: "Selesai Bongkar di Lokasi 2",
              date: sub(new Date(), { hours: 3 }).toISOString(),
              requiresQRScan: false,
              requiresPhoto: true,
              triggersWaitingFee: false,
        ...
        },
        {
          ...
          children: [
            {
              statusCode: "SELESAI_MUAT_1",
              statusName: "Selesai Muat di Lokasi 1",
              date: sub(new Date(), { hours: 6 }).toISOString(),
              requiresQRScan: false,
              requiresPhoto: true,
              triggersWaitingFee: false,
