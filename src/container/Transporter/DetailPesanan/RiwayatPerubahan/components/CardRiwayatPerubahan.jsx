                  ...
                  <CollapsibleContent>
                    <div className="m-4 rounded-lg border border-neutral-400 p-4">
                      <div className="flex items-center gap-2">
                        <span className="grid h-8 w-8 place-items-center rounded-full bg-muat-trans-primary-400">
                          <IconComponent
                            src={"/icons/card-perubahan/armada.svg"}
                            width={16}
                            height={16}
                            className="text-muat-trans-secondary-900"
                          />
                        </span>
                        <p className="text-xs font-bold">Perubahan Armada</p>
                      </div>
                      <div className="mt-4 flex items-center justify-between gap-4 border-t border-neutral-400 px-2 py-4 md:px-6">
                        <div className="flex-1">
                          <p className="mb-3 text-xs font-medium text-neutral-600">
          ...
          !showBatalPesananHistory && (
            <>
              ...
              <TimelineItem isLast>
                ...
                <div className="w-full">
                  <p className="mb-3 text-xs font-medium">
                    <span className="font-semibold">Shipper</span> telah
                    melakukan perubahan pesanan.
                  </p>
                  <Collapsible
                    defaultOpen
                    className="rounded-lg border border-neutral-400"
