...
const PilihArmadaBatalkan = ({
  ...
  const { data } = useGetActiveOrdersFleet(order?.orderId);
  useEffect(() => {
    if (data) {
      setFleetList(data.Data.fleetList || []);
    }
  }, [data]);
                ...
                <div key={fleet.id || index} className="w-full">
                  <div className="flex w-full items-center gap-4 py-4">
                    ...
                    <div className="flex flex-1 items-center gap-4">
                      ...
                      <ImageArmada
                        src={
                          fleet.vehicleInfo.imageUrl ||
                          dummyImages[index % dummyImages.length]
                        }
                        plateNumber={fleet.vehicleInfo.licensePlate}
                        size="sm"
                      />
                      ...
                      <div className="flex h-[44px] flex-1 flex-col items-start justify-center gap-3 py-1">
                        ...
                        <div className="h-2 w-full">
                          <p className="text-xs font-bold leading-[120%] text-black">
                            {fleet.vehicleInfo.licensePlate || "AE 1111 LBA"}
                          </p>
                        </div>
                        ...
                        <div className="flex h-4 w-full items-center gap-1 p-0">
                          ...
                          <div className="w-full">
                            <p className="text-xs font-medium text-black">
                              {fleet.driverInfo.driverName || "Noel Gallagher"}
                            </p>
                          </div>
                        </div>
                      </div>
